...
replacement = r'''{/* Total Siswa */}
              ...
              <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col items-center justify-center text-center h-40 md:h-48 relative overflow-hidden group hover:shadow-md transition-shadow">
                ...
                <div className="w-full flex justify-center gap-1 items-baseline mb-1">
                ...
                <div className="w-full max-w-[80%] mx-auto bg-slate-100 dark:bg-slate-700 rounded-full h-2 mb-2 overflow-hidden">
...
new_content = re.sub(
    r'\{\/\* Total Siswa \*\/}.*?\{\/\* Class Breakdown Section \*\/\}',
    replacement,
    content,
    flags=re.DOTALL
)
