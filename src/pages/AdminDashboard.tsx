  ...
  return (
    <div className="max-w-7xl mx-auto">
      <header className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div className="flex items-center gap-3">
          {waProgress && waProgress.isRunning && (
            <div className="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-4 py-2 rounded-xl text-sm font-medium flex items-center gap-2 border border-blue-200 dark:border-blue-800">
              <span className="w-2 h-2 bg-blue-500 rounded-full animate-ping"></span>
              Mengirim WA... {waProgress.sent}/{waProgress.total}
            </div>
          )}
          <button 
                      ...
                      try {
                        ...
                        if (progData.success) {
                          ...
                          if (!prog.isRunning) {
                            ...
                            setTimeout(() => {
                              alert(`Pengiriman selesai. Terkirim: ${prog.sent}, Gagal: ${prog.failed}`);
                              setWaProgress(null);
                            }, 500);
                          }
                        }
            ...
            className={`${waProgress?.isRunning ? 'bg-slate-400 cursor-not-allowed' : 'bg-green-500 hover:bg-green-600'} text-white px-4 py-2 rounded-xl text-sm font-medium transition-colors flex items-center gap-2 shadow-sm`}
          >
