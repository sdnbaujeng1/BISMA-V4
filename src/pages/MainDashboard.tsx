...
export default function MainDashboard({ user, onLogout, onNavigate, darkMode, toggleDarkMode }: { user: any, onLogout: () => void, onNavigate: (page: string) => void, darkMode: boolean, toggleDarkMode: () => void }) {
  ...
  const menuItems = [
    ...
    { id: 'game_generator', url: 'https://script.google.com/macros/s/AKfycbxg4OScIlFNDzkksUBfb5l6iYZqpRqPOoG94AazQESC0llZS5_nkHQIkJgNIUhNCzy21Q/exec', icon: Gamepad2, label: 'Game Generator', gradient: 'from-yellow-400 to-orange-500', shadow: 'shadow-orange-500/40', roles: ['guru'] },
  ];
                ...
                <div className="space-y-4 text-left">
                  ...
                  <div className="flex items-center gap-4 p-3 bg-slate-50 dark:bg-slate-700/50 rounded-xl">
                    ...
                    <div>
                      ...
                      <a href="https://api.whatsapp.com/send?phone=6285749662221" target="_top" rel="noopener noreferrer" className={`font-semibold ${currentTheme.text} hover:underline`}>
                        085749662221
                      </a>
                    </div>
                  </div>
